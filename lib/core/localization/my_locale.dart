...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en': {
      ...
      'ticket_not_found_in_this_trip': 'Ticket not found in this trip',
      'ticket_already_verified_locally': 'ticket already verified locally',
      ...
      'trip_not_started_yet':
          'Trip not started yet - tracking will begin when trip starts',
      'trip_already_completed':
          'Trip already completed - location tracking unavailable',
      'trip_cancelled': 'Trip cancelled - no active tracking',
      ...
      "gps_disabled_title": "GPS service is disabled",
    },
    'ar': {
      // General
      ...
      "status": "الحالة",
      'ticket_not_found_in_this_trip':
          "لم يتم العثور على التذكرة في هذه الرحلة",
      'ticket_already_verified_locally': 'تم التحقق من التذكرة محلياً مسبقا',
      // Notifications Screen
      ...
      "gps_disabled_title": "خدمة تحديد الموقع (GPS) معطلة",
      //  Snackbars والـ Dialogs
      ...
      'trip_not_started_yet':
          'لم تبدأ الرحلة بعد - سيبدأ التتبع عند بدء الرحلة',
      'trip_already_completed': 'الرحلة مكتملة - لا يمكن تتبع الموقع',
      'trip_cancelled': 'الرحلة ملغية - لا يوجد تتبع نشط',
    },
  };
}
